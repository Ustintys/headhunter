  ...
  return (
    <>
      <Group gap={12}>
        ...
        />
        <Button onClick={() => {dispatch(fetchVacancy({page: 1, search: valueInputVacancy, city: valueInputCity, skills: skills}))}} radius="sm" fw={400}>Найти</Button>
      </Group>
    </>
  )
}
